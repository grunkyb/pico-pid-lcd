...
"""
Waveshare driver for Pico 0.96 LCD with buttons and joystick
https://www.waveshare.com/wiki/Pico-LCD-0.96

Based on https://www.waveshare.com/w/upload/9/9c/Pico_LCD_code.zip
Excludes the "game" to show off the button functions 
"""
...
if __name__=='__main__':
    ...
    lcd = LCD_0inch96()   
    lcd.fill(PURPLE)   
    lcd.text("PID controller",24,15,YELLOW)
    lcd.text("Chris Blanford",24,35,YELLOW)    
    lcd.text("2022-02-25",40,55,YELLOW)
    lcd.display()
